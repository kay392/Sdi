...
<div class="page" id="page-succession">
  ...
  <!-- Challenges -->
  <section class="challenges-section" id="market-landscape">
    <div class="container">
  ...
  <!-- Stay in Market -->
  <section class="stay-section" id="optimising-investment-portfolio">
    <div class="container">
      <div class="stay-grid">
        <div>
...
In reality, nine out of ten clients we work with do not need to sell. They simply need a more strategic route forward. By carefully repositioning assets, unlocking value, increasing income security, or improving access to capital, we help many investors remain in the UK market with greater confidence, stronger performance, and less stress.
          ...
          <img src="Assets/About_Page/sucession.png" alt="Property" style="border-radius:14px;width:100%;height:192px;object-fit:cover;margin-top:1.5rem;box-shadow:0 6px 20px rgba(0,0,0,0.1);"/>
        </div>
        <div>
  ...
  <!-- Exit Features -->
  <section class="exit-section" id="exit-strategy">
    <div class="container">
          ...
          <form id="valuationForm"">
            <div class="form-grid">
              ...
              <select id="property_type"
                    ...
                    multiple
                    required>
                <option value="" disabled>Select Property Type(s)</option>

                <option value="Residential (Single Dwelling)">Residential (Single Dwelling)</option>
                <option value="HMO / Multi-let">HMO / Multi-let</option>
                <option value="Block of Flats / Apartment Complex">Block of Flats / Apartment Complex</option>
                <option value="Supported / Specialist Housing">Supported / Specialist Housing</option>
...
<script src="https://www.google.com/recaptcha/api.js" async defer></script>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
          new Choices('#property_type', {
              removeItemButton: true,
              placeholder: true,
              placeholderValue: 'Select Property Type(s)',
              searchPlaceholderValue: 'Select Property Type(s)',
              itemSelectText: '',
              shouldSort: false
          });
      });
